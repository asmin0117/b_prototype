...
# sleep 3
# docker exec cli peer chaincode invoke -n $CCNAME -C $CHNAME -c '{"Args":["queryReqTransportation", "TC0"]}'
# sleep 3
# docker exec cli peer chaincode invoke -n $CCNAME -C $CHNAME -c '{"Args":["regTransportation", "TC1", "a/c222",  "5", "Seoul", "Busan", "1000", "10"]}'
# sleep 3
# docker exec cli peer chaincode invoke -n $CCNAME -C $CHNAME -c '{"Args":["queryRegTransportation", "TC1"]}'
# sleep 3
